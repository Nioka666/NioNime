...
const EpisodesPagination: React.FC<EpisodesPaginationProps> = ({ episodes, onEpisodeClick, currentEpisodeIndex }) => {
    ...
    const renderPagination = () => {
        ...
        for (let i = startPage; i <= endPage; i++) {
            ...
            const isActive = currentEpisodeIndex >= indexOfFirstEpisode && currentEpisodeIndex < indexOfLastEpisode;
            ...
            <div className="d-flex gap-3 m-top-25" style={{ flexWrap: 'wrap' }}>
                ...
                {!loading &&
                    currentEpisodes.map((episode, index) => (
                        ...
                        >
                            <h6 style={{ margin: '0px' }}>EP {episode.number}</h6>
                        </button>
                    ))}
            </div>
